export const challenges = [
	...
	},
	{
		...
		examples: [
			...
			"Example input: 'const date3 = new Date('Dec 24, 2021 23:59:59' daysToXmas(date3) // 1'",
			"Example input: 'const date4 = new Date('December 20, 2021 03:24:00') daysToXmas(date4) // 5''",
		],
		tester: [""],
		methods: ["", "", "", "", "", ""],
		explanations: [
